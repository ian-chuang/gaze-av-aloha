...
def main():
    ...
    while True:
        ...
        if teleop_active:
            ...
            left_delta = (
                T_left[:3, 3] - T_left_ref[:3, 3]
            )

            right_delta = (
                T_right[:3, 3] - T_right_ref[:3, 3]
            )

            head_delta = (
                T_head[:3, 3] - T_head_ref[:3, 3]
            )
        ...
        right_ee_frame.position = T_right_ee[:3, 3]
        middle_ee_frame.position = T_middle_ee[:3, 3]
