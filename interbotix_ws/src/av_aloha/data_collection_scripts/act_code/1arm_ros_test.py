...
def main():
    ...
    rospy.init_node("vr_right_arm_teleop")
    ...
    joint_velocity_limits[right_arm_indices] = np.array([
        2.0,
        2.0,
        2.0,
        4.0,
    ...
    right_arm_q = np.array(
        bot.arm.get_joint_commands()
    )

    q[right_arm_indices] = right_arm_q """
