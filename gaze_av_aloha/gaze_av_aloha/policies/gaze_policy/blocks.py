...
from gaze_av_aloha.policies.gaze_policy.attention import Attention, CrossAttention
...
class CrossAttentionAdaLNBlock(nn.Module):
    ...
    def forward(self, x, t, c):
        shift_msa, scale_msa, gate_msa, shift_mlp, scale_mlp, gate_mlp = self.ada_ln(t).chunk(6, dim=1)
