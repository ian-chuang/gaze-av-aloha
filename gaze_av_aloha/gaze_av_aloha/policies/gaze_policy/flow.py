...
from gaze_av_aloha.policies.gaze_policy.pos_embed import SinusoidalPosEmbed
from gaze_av_aloha.policies.gaze_policy.blocks import get_flow_transformer_block
...
class FlowTransformer(nn.Module):
    def __init__(
        ...
        if block_type == "cross_adaln":
            self.cond_embed = nn.LayerNorm(hidden_dim)
        else:
